...
{
  unsafe  public class Form : Control
    {
        ...
        static unsafe void HandleSendTextAreaFocusCb(lv_event_t* e)
        {
          ...
          IntPtr MyWndProc(IntPtr hWnd, uint msg, UIntPtr wParam, IntPtr lParam)
        {
            switch (msg)
            {
                case WM_DESTROY:
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            // 确保DPI感知已设置
            uint dpi = DpiHelper.GetWindowDpi(this.Handle);
            Console.WriteLine($"当前窗口DPI: {dpi}");
        }
        public void Init()
        {
        ...
        public  new  Size ClientSize { get =>base.ClientSize; set { 
            
           base.ClientSize= value;
                OnClientSizeChanged(new EventArgs());
            } }
        ...
        protected override void OnClientSizeChanged(EventArgs e)
        {
            ...
            // 计算窗口矩形
            var rect = WindowSizeCalculator.CalculateWindowRect(
                clientWidth,
                clientHeight,
                NativeMethods.WS_OVERLAPPEDWINDOW,
                0, 
              ContextMenuStrip != null,  // 如果有菜单栏
                dpi);
